...
# Form implementation generated from reading ui file 't1_4.ui'
#
...
from t1_5 import Ui_MainWindow4
...
class Ui_MainWindow3(object):
    ...
    def setupUi(self, MainWindow3):
        ...
        self.NEXT.clicked.connect(MainWindow3.close)
    ...
    def retranslateUi(self, MainWindow3):
        ...
        self.label.setText(_translate("MainWindow3", "4"))
        self.label_2.setText(_translate("MainWindow3", "Which of the following cannot be uesd as identifiers in python?"))
        self.radioButton.setText(_translate("MainWindow3", "A to Z"))
        self.radioButton_2.setText(_translate("MainWindow3", "#@$%"))
        self.radioButton_3.setText(_translate("MainWindow3", "0 to 9"))
        self.NEXT.setText(_translate("MainWindow3", "NEXT"))
        self.label_3.setText(_translate("MainWindow3", "Your score is:"))
        self.label_4.setText(_translate("MainWindow3", "TextLabel"))
