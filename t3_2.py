...
# Form implementation generated from reading ui file 't3_2.ui'
#
...
from t3_3 import Ui_MainWindow12
...
class Ui_MainWindow11(object):
    ...
    def setupUi(self, MainWindow11):
        ...
        self.NEXT.clicked.connect(MainWindow11.close)
    ...
    def retranslateUi(self, MainWindow11):
        ...
        self.label.setText(_translate("MainWindow11", "2"))
        self.label_2.setText(_translate("MainWindow11", "Which of following is not a decision-making statement?"))
        self.radioButton.setText(_translate("MainWindow11", "if (a >= 2)"))
        self.radioButton_2.setText(_translate("MainWindow11", "else"))
        self.radioButton_3.setText(_translate("MainWindow11", "while"))
        self.NEXT.setText(_translate("MainWindow11", "NEXT"))
        self.label_3.setText(_translate("MainWindow11", "Your score is:"))
        self.label_4.setText(_translate("MainWindow11", "TextLabel"))
