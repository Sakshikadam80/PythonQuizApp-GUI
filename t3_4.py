...
# Form implementation generated from reading ui file 't3_4.ui'
#
...
from t3_5 import Ui_MainWindow14
...
class Ui_MainWindow13(object):
    ...
    def setupUi(self, MainWindow13):
        ...
        MainWindow13.resize(480, 430)
        self.centralwidget = QtWidgets.QWidget(MainWindow13)
        ...
        self.NEXT.clicked.connect(MainWindow13.close)
        ...
        self.menubar = QtWidgets.QMenuBar(MainWindow13)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 480, 26))
        self.menubar.setObjectName("menubar")
        MainWindow13.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(MainWindow13)
    ...
    def retranslateUi(self, MainWindow13):
        ...
        self.label.setText(_translate("MainWindow13", "4"))
        self.label_2.setText(_translate("MainWindow13", "A loop becomes infinte loop if condition never _______"))
        self.radioButton.setText(_translate("MainWindow13", "true"))
        self.radioButton_2.setText(_translate("MainWindow13", "false"))
        self.radioButton_3.setText(_translate("MainWindow13", "null"))
        self.NEXT.setText(_translate("MainWindow13", "NEXT"))
        self.label_3.setText(_translate("MainWindow13", "Your score is:"))
        self.label_4.setText(_translate("MainWindow13", "TextLabel"))
