...
# Form implementation generated from reading ui file 't2_5.ui'
#
...
class Ui_MainWindow9(object):
    ...
    def setupUi(self, MainWindow9):
        ...
        self.SUBMIT.clicked.connect(MainWindow9.close)
    ...
    def retranslateUi(self, MainWindow9):
        ...
        self.label.setText(_translate("MainWindow9", "5"))
        self.label_2.setText(_translate("MainWindow9", "Which function is uesd to find length of list?"))
        self.radioButton.setText(_translate("MainWindow9", "len()"))
        self.radioButton_2.setText(_translate("MainWindow9", "max()"))
        self.radioButton_3.setText(_translate("MainWindow9", "size()"))
        self.SUBMIT.setText(_translate("MainWindow9", "SUBMIT"))
        self.label_3.setText(_translate("MainWindow9", "Your score is:"))
        self.label_4.setText(_translate("MainWindow9", "TextLabel"))
