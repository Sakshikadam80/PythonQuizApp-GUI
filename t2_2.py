...
# Form implementation generated from reading ui file 't2_2.ui'
#
...
from t2_3 import Ui_MainWindow7
...
class Ui_MainWindow6(object):
    ...
    def setupUi(self, MainWindow6):
        ...
        self.NEXT.clicked.connect(MainWindow6.close)
    ...
    def retranslateUi(self, MainWindow6):
        ...
        self.label.setText(_translate("MainWindow6", "2"))
        self.label_2.setText(_translate("MainWindow6", "Which of the following is a immutable data type?"))
        self.radioButton.setText(_translate("MainWindow6", "list"))
        self.radioButton_2.setText(_translate("MainWindow6", "set"))
        self.radioButton_3.setText(_translate("MainWindow6", "tuple"))
        self.NEXT.setText(_translate("MainWindow6", "NEXT"))
        self.label_3.setText(_translate("MainWindow6", "Your score is:"))
        self.label_4.setText(_translate("MainWindow6", "TextLabel"))
